...
namespace Crm.Persistence.Repositories
{
    public class TaskDetailsRepository : ITaskDetailsRepository
    {
        ...
        public async Task<List<TaskDetails>> GetTaskByIdAsync(List<int> id)
        {
            var tasks = await _context.TaskDetails
                .Include(t => t.Clients)
        ...
        public async Task UpdateTaskAsync(List<TaskDetails> tasks)
        {
            _context.TaskDetails.UpdateRange(tasks);
            await _context.SaveChangesAsync();
        }

        public async Task IsArchivedTaskAsync(bool isArchived, List<int> taskId)
        {
